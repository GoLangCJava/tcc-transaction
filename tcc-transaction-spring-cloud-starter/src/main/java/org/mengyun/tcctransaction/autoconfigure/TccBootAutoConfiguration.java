...
public class TccBootAutoConfiguration {
    ...
    public TransactionRepository transactionRepository(ObjectSerializer<?> serializer) {
        ...
        TccConfigProperties.DataSourceConfig dataSourceAutoConfig = props.getDataSourceConfig();
    ...
    public RecoverConfig recoverConfig() {
        ...
        TccConfigProperties.RecoverConfig recoverAutoConfig = props.getRecoverConfig();
